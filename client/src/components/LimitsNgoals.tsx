  ...
  return (
    <div className="p-5 grid grid-cols-3 gap-4 mt-5 w-full max-md:grid-cols-1 max-xl:grid-cols-2">
      ...
      <div className="bg-white rounded-2xl p-5 flex flex-col gap-4">
         ...
         <input type="number" className='border border-gray-300 rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500'/>
      <button className='p-3 bg-sky-100 rounded absolute right-[1px] top-[1px] cursor-pointer'><Plus size={16} color='blue' className='cursor-pointer active:scale-90'/></button></div>
      </div>
    </div>
  )
}
