...
const Loader = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center fixed bg-gray-700/40 z-50">
        <div className="animate-spin grid grid-cols-2 gap-2 z-60">
      <div className="animate-bounce bg-blue-700 rounded-full h-4 w-4  "></div>
