...
const Analytics = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-4 max-sm:mt-8">John's Analytics</h1>
      <p className="text-gray-600">This is the analytics page. Here you can view various metrics and insights about your finances. You can search for all the financial reports here.</p>
      <div className="mt-6 relative max-w-sm group peer focus-within:z-30 focus-within:bg-white">
        <input 
          type="text" 
          placeholder="Search..." 
        ...
        />
        <Search className="absolute right-3 top-3 text-gray-400 cursor-pointer" size={16} />
      <div className="max-w-sm p-3 rounded bg-slate-100 group-focus-within:block hidden absolute top-12 left-0 z-30 w-full shadow-lg">
        {reports.filter((report) => report.title.toLowerCase().includes(searchTerm.toLowerCase())).map((report, index) => (
          ...
          <p className="p-4 text-gray-600">No reports found.</p></div> }
      </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-600">Analyze your spending habits and identify areas for improvement.</p>
      </div>
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">Biggest vs lowest monthly savings</h2>
        <p className="text-gray-600">Analyze trends in your money savings over time.</p>
      </div>
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">Cash flow analysis</h2>
        <p className="text-gray-600">Understand your cash flow and identify areas for improvement.</p>
      </div>
      <div className="mt-6">
