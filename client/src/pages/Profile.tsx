...
const Profile = () => {
  ...
  return (
    <div className="p-15 max-sm:pb-30 max-sm:p-5 max-sm:pt-17 max-sm:m-autp-10">
        ...
        <div className="p-10 flex mt-10 justify-between gap-10 border border-gray-300 rounded-4xl shadow relative max-sm:flex-col max-sm:pt-20 max-sm:mx-auto ">
        <div className="rounded-full w-40 h-40 bg-gray-400 flex items-center justify-center text-8xl text-white max-md:text-5xl max-xl:w-40 max-xl:h-40 max-xl:text-6xl"><User2 size={80}/> 
        </div>
