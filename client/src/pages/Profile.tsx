...
const Profile = () => {
  return (
    <div className="p-15 max-sm:pb-30 max-sm:p-5 max-sm:pt-17 max-sm:m-auto">
        ...
        <button className="flex gap-2 cursor-pointer border-2 border-blue-300 bg-linear-to-r from-blue-200 items-center to-blue-100 text-blue-700 absolute bottom-7 left-7 py-2 px-4 rounded-lg max-sm:top-7 max-sm:right-7 max-sm:bottom-auto max-sm:left-auto max-sm:py-1 max-sm:px-2 max-sm:text-sm">Edit Profile <Pencil size={16}/></button>
        </div>
        </div>
  )
}
